...
train_graphs = [mol_to_graph_data_obj(m, r, y) for m, r, y in zip(train['Mol'], train_rdkit_feats, train['Inhibition']) if m is not None]
...
# ✔️ 최종 GNN R2 Score: 0.9905

# 📦 모델 저장 완료: C:/Study25/_data/dacon/boost_up/gnn_model_20250721_170930.pt
# 📄 제출 파일 저장 완료: C:/Study25/_data/dacon/boost_up/submission_gnn_20250721_170930.csv