...
# ── 5) QuantumCircuit 모듈 (4 큐빗, 60 파라미터로 확장) ─────────────────
try:
    # 큐빗 수를 4개로 변경
...
# ── 6) HybridCNN (퀀텀 모델에 맞춰 FC 레이어 수정) ──────────────────────
class HybridCNN(Module):
    def __init__(self, activation):
        ...
        self.fc1   = Linear(48,   64) # Global Average Pooling 후 입력 크기: 48
        self.fc2   = Linear(64,   4)  # QNN 입력 크기 4에 맞춤
...
def run_experiment(hp):
    ...
    qc = QuantumCircuit()
    specs = qml.specs(qc.circuit)(torch.randn(4), qc.weights) # 입력 크기를 4로 변경
...
# ▶ Saved submission\y_pred_20250804_200938.csv (Best Val Acc 0.8667) -> 0.8635

# === Experiment: optim=adam, act=elu ===
# ▶ Saved submission\y_pred_20250804_224156.csv (Best Val Acc 0.8600)

# === Experiment: optim=adam, act=selu ===
# ▶ Saved submission\y_pred_20250805_010634.csv (Best Val Acc 0.8533)

# === Experiment: optim=rmsprop, act=relu ===
# ▶ Saved submission\y_pred_20250805_022512.csv (Best Val Acc 0.8408)

# === Experiment: optim=adadelta, act=relu ===
# ▶ Saved submission\y_pred_20250805_040823.csv (Best Val Acc 0.8617) -> 0.85
