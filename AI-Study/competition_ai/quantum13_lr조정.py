...
# ── 6) HybridCNN (파라미터 수를 32000개 수준으로 조정) ─────────────────
class HybridCNN(Module):
    def __init__(self, activation):
        super().__init__()
        self.act   = activation
        # Conv 레이어 채널 수 조정
        self.conv1 = Conv2d(1, 16, 3, padding=1); self.bn1 = BatchNorm2d(16)
        self.conv2 = Conv2d(16, 32, 3, padding=1); self.bn2 = BatchNorm2d(32)
        self.conv3 = Conv2d(32, 64, 3, padding=1); self.bn3 = BatchNorm2d(64)
        self.drop  = Dropout2d(0.4)
        
        # FC 레이어 노드 수 조정
        self.fc1   = Linear(64,  128) # Global Average Pooling 후 입력 크기: 64
        self.fc2   = Linear(128,  4)  # QNN 입력 크기 4에 맞춤
...
# ▶ Saved submission\y_pred_20250805_034811.csv (Best Val Acc 0.8467)