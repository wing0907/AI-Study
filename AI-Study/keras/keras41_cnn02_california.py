...
print(x_train.shape, y_train.shape) # (20640, 4, 2, 1) (16512,)
print(x_test.shape, y_test.shape)   # (20640, 4, 2, 1) (4128,)



model = Sequential()
model.add(Conv2D(128, (1,1), strides=1, padding='same', input_shape=(4,2,1)))                                    
