...
from tensorflow.keras.layers import Conv1D, Dropout, MaxPooling2D, Flatten, Dense, BatchNormalization
import numpy as np
...
model.add(Conv1D(filters=128, kernel_size=2, 
                 padding='same', activation='relu', input_shape=(64,1)))
model.add(Flatten())                                    
