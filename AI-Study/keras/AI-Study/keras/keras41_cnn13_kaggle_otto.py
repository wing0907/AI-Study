...
x_train = x_train.reshape(-1,93,1,1)
x_test = x_test.reshape(-1,93,1,1)


print(x_train.shape, y_train.shape) # (49502, 93, 1, 1) (49502, 9)
print(x_test.shape, y_test.shape)   # (12376, 93, 1, 1) (12376, 9)


model = Sequential()
model.add(Conv2D(128, (1,1), strides=1, padding='same', input_shape=(93,1,1)))                                    
