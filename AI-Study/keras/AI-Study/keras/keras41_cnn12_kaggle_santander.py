...
print(x_train.shape, y_train.shape) # (160000, 200, 1, 1) (160000,)
print(x_test.shape, y_test.shape)   # (40000, 200, 1, 1) (40000,)


model = Sequential()
model.add(Conv2D(128, (1,1), strides=1, padding='same', input_shape=(200,1,1)))                                    
