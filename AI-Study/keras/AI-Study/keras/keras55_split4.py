...
x_pred = split_xy_predict(x_predict, timesteps=10)
...
model = Sequential()
model.add(LSTM(units=100, input_shape=(5, 2), activation='relu')) #  return_sequences=True = 3차원으로 그대로 출력. 성능은 보장못함. 좋을수도 있고 나쁠수도 있음
