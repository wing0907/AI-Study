...
path_train = 'C:\Study25\_data\kaggle\men_women\\'

start = time.time()
xy_train = train_datagen.flow_from_directory(
    path_train,                    #경로
    target_size=(250, 250),        #원 사이즈 150,150 가 해당 사이즈로 자동변환 됨 resize
...
print('x.shape :', x.shape) # x.shape : (3309, 300, 300, 3)
...
np.save(np_path + "keras46_07_x_train.npy", arr=x)
np.save(np_path + "keras46_07_y_train.npy", arr=y)
