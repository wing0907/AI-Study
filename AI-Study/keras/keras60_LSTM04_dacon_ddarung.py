...
from tensorflow.python.keras.layers import Dense,  BatchNormalization, Dropout, Input, LSTM, Flatten, MaxPooling2D
...
model = Sequential()
model.add(LSTM(units=128, return_sequences=True, input_shape=(9,1)))                                    
