...
print(x_train.shape, y_train.shape) # (142, 13, 1) (142,)
print(x_test.shape, y_test.shape)   # (36, 13, 1) (36,)
...
start = time.time()
hist = model.fit(x_train, y_train, epochs=5, batch_size=24,
                 verbose=1,
...
# r2: 0.9086
# 걸린시간: 48.801284313201904 초

# r2: 0.1534
# 걸린시간: 4.0959999561309814 초